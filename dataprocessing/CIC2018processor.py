...
import pandas as pd
def main():
    df = pd.read_csv('/Users/bryan/documents/00-classwork/02-capstone/forGIT/originalcsvfiles/edited2018CIC_Friday-02-03-2018_TrafficForML_CICFlowMeter_original.csv')
